            ...
            let bindTemplate = `<div id="${this.id.self}">
                ...
                <div id="header" class=""><!-- scroll_on -->
                    <div class="header_inner">
                        <h1 class="sbscnbc_logo"><a href="http://sbscnbc.sbs.co.kr" class="scl_link icn"><i class="ir">SBSCNBC 의견 있는 경제채널</i></a></h1>
                        <h2 class="hide">SBSCNBC 메인메뉴</h2>
                        <ul>
                            <li class="snb_cont" id="${this.id.menu}-news">
                                <a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=04" class="snb_link_news"><span class="icn"><i class="ir">뉴스</i></span></a><!--해당 페이지일 경우 on 추가-->
                                <div class="snbc_list_w"><!--활성화시 current 추가 -->
                                    <ul class="snbcl_news">
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=04" class="snbc_link">경제</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=03" class="snbc_link">금융</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=01" class="snbc_link">증권</a></li><!--활성화시 select 추가-->
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=02" class="snbc_link">글로벌</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=05" class="snbc_link">산업</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=07" class="snbc_link">부동산</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=08" class="snbc_link">시사</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/news/news_list.jsp?pmCategory=14" class="snbc_link">속보</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="snb_cont" id="${this.id.menu}-biz">
                                <a href="http://sbscnbc.sbs.co.kr/new/investment/index.jsp?pmMenumType=stock" class="snb_link_biz"><span class="icn"><i class="ir">재테크</i></span></a>
                                <div class="snbc_list_w">
                                    <ul class="snbcl_biz">
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/investment/index.jsp?pmMenumType=stock" class="snbc_link">증권정보</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/investment/index.jsp?pmMenumType=finance" class="snbc_link">재무</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/investment/index.jsp?pmMenumType=property" class="snbc_link">부동산정보</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="snb_cont" id="${this.id.menu}-ceo">
                                <a href="http://sbscnbc.sbs.co.kr/ceo_file/index_new.jsp" class="snb_link_ceo"><span class="icn"><i class="ir">CEO</i></span></a>
                                <div class="snbc_list_w">
                                    <ul class="snbcl_ceo">
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/ceo_file/index_new.jsp" class="snbc_link">취재파일</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/corner/corner_list.jsp?pmCornerId=10000003261" class="snbc_link">CEO&amp;Leaders</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/corner/corner_list.jsp?pmCornerId=10000009260" class="snbc_link">블루베리</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="snb_cont" id="${this.id.menu}-program">
                                <a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp" class="snb_link_program"><span class="icn"><i class="ir">프로그램</i></span></a>
                                <div class="snbc_list_w">
                                    <ul class="snbcl_program">
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp" class="snbc_link">전체</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp?pmCategoryId=01" class="snbc_link">뉴스</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp?pmCategoryId=02" class="snbc_link">재테크</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp?pmCategoryId=04" class="snbc_link">CEO</a></li>
                                        <li class="snbc_cont"><a href="http://sbscnbc.sbs.co.kr/new/prog/index.jsp?pmCategoryId=03" class="snbc_link">교양</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                        <div class="hi_right">
                            ...
                            <ul class="gnb">
                                ...
                                <li class="gnb_cont"><a href="http://sbscnbc.sbs.co.kr/sub/channel.jsp" class="gnb_link">채널번호</a></li>
                                ...
                                <li class="gnb_cont"><a href="http://sbscnbc.sbs.co.kr/sub/qna_new.jsp" class="gnb_link">시청자게시판</a></li>
